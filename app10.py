...
# =====================================================================
#  HARDCODED MASTER ROSTER - Jim Bazzano's Organization (115 people)
...
MASTER_ROSTER = [
    ("Jim Bazzano", "Leadership"),
    ("Kris Smith", "Identity & Collaboration"),
    ...
    ("Giridharan Kalidoss", "CCOE"),
    ("Hrithik Raj Umashankar", "CCOE"),
    ("Carolyn Zakrzewski", "CCOE"),
    ("Marnie Cunnington", "CCOE"),
    ("Lainie Klein", "Project & Portfolio Management"),
    ("Charles De Pommerol", "Project & Portfolio Management"),
    ("Reem Mohanty", "Project & Portfolio Management"),
    ("Quentin Jaubert", "Project & Portfolio Management"),
    ("Marty Monaco", "Project & Portfolio Management"),
    ("Dave Mitchell", "Project & Portfolio Management"),
    ("Laksh Maggoo", "Project & Portfolio Management"),
    ("Mason Gross", "Project & Portfolio Management"),
    ("Mohssen Toumi", "Project & Portfolio Management"),
    ("Alvin Autar", "Cloud Transformation"),
    ("Josalin Dunn", "Cloud Transformation"),
    ("Clement Moreau", "Cloud Transformation"),
    ("Amee Shah", "Cloud Transformation"),
    ("Sean Adams", "Cloud Transformation"),
    ("Karl Sung", "Cloud Transformation"),
    ("Youssef Lakranbi", "Cloud Transformation"),
    ("Nir Ashkenazi", "Cloud Transformation"),
    ("Amir Liss", "Cloud Transformation"),
    ("Tim Pitta", "Cloud Transformation"),
    ("Bob George", "Cloud Transformation"),
    ("Alyssa Shirman", "Cloud Transformation"),
    ("Scott Knopf", "Cloud Transformation"),
    ("Adam May", "Cloud Transformation"),
    ("Deepti Tirumala", "Cloud Transformation"),
    ("Oleg Chugaev", "Cloud Transformation"),
    ("Emmanuel Enumegukae", "Cloud Transformation"),
    ("John Manchisi", "Cloud Transformation"),
    ("Nico Suarez-Canton", "Cloud Transformation"),
    ("Evangelos Thomatos", "Cloud Transformation"),
    ("Clem Donavan", "Cloud Transformation"),
    ("Lisa Shuster", "Cloud Transformation"),
    ("Ingrid Rodriguez", "Cloud Transformation"),
    ("Dave Stoner", "Cloud Transformation"),
    ("Joe Overkamp", "Cloud Transformation"),
    ("Dan Peacock", "Cloud Transformation"),
    ("Julia Klein-Freeman", "Cloud Transformation"),
    ("Jeremy Smitherman", "Cloud Transformation"),
    ("Rohit Chaudhari", "Cloud Transformation"),
    ("Cynthia Hartley-Cisco", "Cloud Transformation"),
    ("Rahman Shaik", "Cloud Transformation"),
    ("Paul Schmid", "Cloud Transformation"),
    ("Katie Ryan", "Cloud Transformation"),
    ("Yarden Sartena", "Cloud Transformation"),
    ("Ray Chin", "Cloud Transformation"),
    ("Cedric Towner", "Cloud Transformation"),
    ("Geethanjali Malladi", "Cloud Transformation"),
    ("Vipul Kumar", "Cloud Transformation"),
    ("Rhenise Lucot", "Cloud Transformation"),
    ("Gary Clough", "Contingent Worker"),
    ("Frank Bennack", "Executive Support"),
    ("Buffy Lim Schmidt", "Executive Support"),
    ("Amanda Hearst", "Executive Support"),
    ("Tomasina Delaney", "Executive Support"),
]
...
st.sidebar.caption(
    "The master roster is hardcoded in the app (Jim Bazzano's 115-person org). "
...
if uploaded:
    ...
    summary_lines = []
    tempo_users_df: Optional[pd.DataFrame] = None   # auto-detected from JIRA Users sheet
    ...
    if not roster_df.empty:
        # PRIMARY: Use hardcoded master roster (Jim Bazzano's full 115-person org)
