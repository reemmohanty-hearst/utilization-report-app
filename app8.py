...
st.sidebar.caption(
    "The app **automatically** detects zero-loggers from the `Users` sheet inside the JIRA/Tempo file. "
    "Only upload a roster here if your JIRA file doesn't have a Users sheet, or you want to override."
)
roster_file = st.sidebar.file_uploader(
    "Override roster (CSV or XLSX) — optional",
    type=["csv", "xlsx"],
    key="roster_uploader",
)
